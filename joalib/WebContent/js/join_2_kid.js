		...
		if(mm<10) {
		    mm='0'+mm} 
		//
		var todayMax = yyyy +'-'+ mm +'-'+ dd ;
		var todayMin = (yyyy-12)+'-'+'01'+'-'+'01';

		document.getElementById("member_birth").setAttribute("min", todayMin);
		document.getElementById("member_birth").setAttribute("max", todayMax);
