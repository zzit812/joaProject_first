<%@page import="mvcpr.board.DTO.PageInfo"%>
<%@page import="mvcpr.board.DTO.Postexam"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"%>
<%@ page import="java.util.*"%>
<%@ page import="java.text.SimpleDateFormat"%>

<%
	ArrayList<Postexam> articleList = (ArrayList<Postexam>) request.getAttribute("articleList");
